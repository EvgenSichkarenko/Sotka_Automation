...
class EditPrice:
	...
	copy_of_origin_transcript,cancellation_fee, cancellation_terms):
		wd = self.app.wd
		...
		wd.find_element(By.NAME, "pageCost").send_keys(page_cost)
		wd.find_element(By.NAME, "expertPageCost").send_keys(expert_page_cost)
		wd.find_element(By.NAME, "travel").send_keys(travel)
		wd.find_element(By.NAME, "estimated").send_keys(estimated)
		wd.find_element(By.NAME, "turnAroundTime").send_keys(turn_around_page)
		wd.find_element(By.NAME, "copy").send_keys(copy_of_origin_transcript)
		wd.find_element(By.NAME, "cancellation").send_keys(cancellation_fee)
		wd.find_element(By.NAME, "MuiSelect-nativeInput").send_keys(cancellation_terms)
		#button save
