...
class DepositionCase:
	...
	def download_any_transcript(self):
		...
		time.sleep(1)
		WebDriverWait(wd, 15).until(EC.element_to_be_clickable((By.CSS_SELECTOR,
	...
	cr_name,cr_email,cr_phone):
		...
		time.sleep(1)
		name_cr = cr.find_element(By.CSS_SELECTOR, "h2[data-name='executorAttorneyName']").get_attribute("textContent")
